        ...
        @foreach($all_category_product as $key =>$cate_pro)
          ...
          <tr>
            ...
            {{-- <td>
              ...
              <a onclick="return confirm('Bạn có thực sự muốn xóa danh mục này ???')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
