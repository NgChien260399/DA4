...
class BrandProduct extends Controller
{
    ...
    public function all_brand_product(){
        ...
        $this->AuthLogin();
    	//lấy tất cả dữ liệu trong table gán vào biến $all_brand_product
    	$all_brand_product=DB::table('tbl_brand')->paginate(8);
    	//
    	$manager_brand_product = view('admin.all_brand_product')->with('all_brand_product',$all_brand_product);
		return view('admin_layout')->with('admin.all_brand_product',$manager_brand_product);
    }

    public function save_brand_product(Request $request){ //hàm lưu thương hiệu sản phẩm
        $this->AuthLogin();
    	$data = array();
    ...
    public function show_brand_home($brand_id){
        ...
        $brand_by_id = DB::table('tbl_product')->join('tbl_brand','tbl_product.brand_id','=','tbl_brand.brand_id')->where('tbl_product.brand_id',$brand_id)->where('product_status','0')->get();
